...
const std::string CompressionUtils::base64_table = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                                              "abcdefghijklmnopqrstuvwxyz"
                                              "0123456789+/";

bool CompressionUtils::base64_encode(std::string& data)
{
    int count = 0;
...
bool CompressionUtils::base64_decode(std::string& data)
{
    int count = 0;
...
bool CompressionUtils::decompressString(std::string& data)
{
    z_stream zstream;
...
bool CompressionUtils::compressString(std::string& data)
{
